...
- http-gateway-smoke: `TOKENOPS_CLI=1 npx tsx apps/cli/src/index.ts gateway smoke --url http://127.0.0.1:8787` (readiness endpoint, OpenAI-compatible HTTP shape, model list compatibility, exact cache, runtime stats)
